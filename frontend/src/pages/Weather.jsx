...
const Weather = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl mx-auto bg-gray-900 bg-opacity-50 shadow-md rounded-lg p-4 sm:p-6 mt-4 sm:mt-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          <input
            ...
            className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-800 text-white opacity-70"
          />
          <button
            type="submit"
